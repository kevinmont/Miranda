    ...
    <nav class="navbar navbar-expand-xl navbar-light fixed-top bg-light p-1">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="404.php">Tiendas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="404.php">Contacto</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="buying.php">Carrito</i></a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                        ...
                        <a class="dropdown-item" href="<?php 
                            if(isset($_SESSION['user'])) echo "panel.php"; else echo "newProduct.php";
                        ?>
                        ">
                            <?php 
